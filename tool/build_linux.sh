...
INCLUDES="-I. -Ithird_party -Ithird_party/faad2/include -Ithird_party/faad2/libfaad -Ithird_party/libsamplerate/include -Ithird_party/libsoxr/include -Ithird_party/libsoxr/src -IViPERDSP/include -IViPERDSP/viper -IViPERDSP/viper/effects -IViPERDSP/viper/utils $FFMPEG_CFLAGS"
