...
INCLUDES="-I. -Idsp -Inative/apple/include -Ithird_party -Ithird_party/ffmpeg/include -Ithird_party/libsamplerate/include -Ithird_party/libsoxr/include -Ithird_party/libsoxr/src -Ithird_party/r8brain"
