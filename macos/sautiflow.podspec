...
A cross-platform miniaudio-backed native engine exposed to Flutter through Dart FFI.
  ...
  s.pod_target_xcconfig = {
    ...
    'OTHER_CPLUSPLUSFLAGS' => '$(inherited) -DAE_ENABLE_CURL=1 -O3 -ffast-math -ftree-vectorize',
    'GCC_PREPROCESSOR_DEFINITIONS' => '$(inherited) HAVE_INTTYPES_H=1 HAVE_MEMCPY=1 HAVE_STRING_H=1 HAVE_STRINGS_H=1 HAVE_SYS_TYPES_H=1 PACKAGE="libsamplerate" VERSION="0.2.2" ENABLE_SINC_BEST_CONVERTER=1 ENABLE_SINC_MEDIUM_CONVERTER=1 ENABLE_SINC_FAST_CONVERTER=1',
